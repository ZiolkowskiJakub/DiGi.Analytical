...
namespace DiGi.Analytical.Building
{
    ...
    {
        public static IndexedDoubles IndexedDoubles(this BuildingModel buildingModel, ISpace space, Range<int> range, string category, string id = null)
        {
            ...
            for (int i = 0; i < count_SpaceInternalConditions; i++)
            {
                ...
                double[] values_Profile = spaceInternalCondition?.InternalCondition?[category].Values;
        ...
        public static IndexedDoubles IndexedDoubles(this BuildingModel buildingModel, ISpace space, int start, int end, string category, string id = null)
        {
            return IndexedDoubles(buildingModel, space, new Range<int>(start, end), category, id);
        }
    }
}