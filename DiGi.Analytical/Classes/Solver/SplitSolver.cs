...
namespace DiGi.Analytical.Classes
{
    ...
    /// <para>Derived solvers raise split events, letting a handler decide which <see cref="IUniqueReference"/> each resulting entity receives; without a handler the reference of the split entity is inherited.</para>
    /// </summary>
